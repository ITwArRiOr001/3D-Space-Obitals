...
function slideToLoadingScreen() {
    ...
    setTimeout(() => {
        ...
        animateLoading();
    }, ); // Start animations 200ms into the slide transition
}
...
// Expose globals for screenshot (add only if not already set later in your script.js)
window.scene = scene;
